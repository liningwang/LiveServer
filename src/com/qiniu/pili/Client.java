 ...
 */
public String RTMPPublishURLNone(String domain, String hub, String streamKey) {
    String path = String.format("/%s/%s", hub, streamKey);
//    String token;
//    try {
...
//        return null;
//    }
    return String.format("rtmp://%s%s", domain, path);
}
    /*
        RTMPPublishURL generates RTMP publish URL
        expireAfterSeconds means URL will be invalid after expireAfterSeconds.
